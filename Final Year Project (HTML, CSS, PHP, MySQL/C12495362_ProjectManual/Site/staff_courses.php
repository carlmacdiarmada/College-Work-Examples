...
<input type='submit' STYLE='color: black;  background-color: white;' value='Add Course' /></form></div> <br></div></div></div></div></div>";
}
}
function editcourse()
{
...
<input type='submit' STYLE='color: black;  background-color: white;' value='Edit Course' /></form></div> <br></div></div></div></div></div>";
break;
default:
print "
...
Course: ".course_dropdown($c, "course")."<br />
<input type='submit' STYLE='color: black;  background-color: white;' value='Delete Course' /></form></div> <br></div></div></div></div></div>";
}
}
