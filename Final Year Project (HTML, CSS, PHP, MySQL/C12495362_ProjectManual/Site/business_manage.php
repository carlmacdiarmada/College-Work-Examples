...
</form></div><br></div></div></div></div></div>';
}
else
{
...
<input type="submit" value="Withdraw cash"></form></div><br></div></div></div></div></div>';
}
function sort_debt()
{
global $ir, $inf, $db;
...
<a href="business_manage.php?p=bankrupt&confirm=1">Bankrupt the Company</a> </div><br></div></div></div></div></div> ';
}
else
{
...
Once this has been confirmed there is no chance to go back.<br /><br />
<a href="business_manage.php?p=upgrade&confirm=1">Upgrade the Company</a></div><br></div></div></div></div></div>';
}
else
{
$price_upgrade = (($inf['busEmployees'])*1500000);
...
Once this has been confirmed there is no chance to go back.<br /><br />
<a href="business_manage.php?p=secupgrade&confirm=1">Purchase Security</a></div><br></div></div></div></div></div>';
}
else
{
$price_upgrade = (($inf['busEmployees'])*200000);
