...
<input type='submit' STYLE='color: black;  background-color: white;' value='Create Crime' /></form></div> <br></div></div></div></div></div>";
}
...
<input type='submit' STYLE='color: black;  background-color: white;' value='Edit Crime' /></form></div> <br></div></div></div></div></div>";
}
...
<div class='generalinfo_simple'><br> <br><br>
      ...
      Crime: ".crime_dropdown($c,'crime')."<br />
      <input type='submit' STYLE='color: black;  background-color: white;' value='Delete Crime' /></form></div> <br></div></div></div></div></div>";
   break;
   case 2:
      $target = $_POST['crime'];
...
<div class='generalinfo_simple'><br> <br><br>
      ...
      <input type='submit' STYLE='color: black;  background-color: white;' name='yesorno' value='No' onclick=\"window.location='staff_crimes.php?action=delcrime';\" /></form></div> <br></div></div></div></div></div>";
   break;
   case 3:
...
<input type='submit' STYLE='color: black;  background-color: white;' value='Create Crime Group' /></form></div> <br></div></div></div></div></div>";
}
...
<input type='submit' STYLE='color: black;  background-color: white;' value='Edit Crime Group' /></form></div> <br></div></div></div></div></div>";
}
...
Move crimes in deleted group to: ".crimegroup_dropdown($c, 'crimeGROUP2')."<br />
      <input type='submit' STYLE='color: black;  background-color: white;' value='Delete Crime Group' /></form></div> <br></div></div></div></div></div>";
   break;
   case 2:
...
<input type='hidden' name='cgID2' value='$target2' />
      <input type='submit' STYLE='color: black;  background-color: white;' name='yesorno' value='Yes' />
      <input type='submit' STYLE='color: black;  background-color: white;' name='yesorno' value='No' onclick=\"window.location='staff_crimes.php?action=delcrimegroup';\" /></form></div> <br></div></div></div></div></div>";
   break;
   case 3:
      $target = $_POST['cgID'];
$target2 = $_POST['cgID2'];
...
</tr></form></table></div> <br></div></div></div></div></div>";
}
}
