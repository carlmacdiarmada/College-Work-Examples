...
<input type='submit' STYLE='color: black;  background-color: white;' value='Add Item To Game' /></form></div><br></div></div></div></div></div>";
}
...
$m=$db->query("INSERT INTO items VALUES('',{$_POST['itmtype']},'$itmname','$itmdesc',{$_POST['itmbuyprice']},{$_POST['itmsellprice']},$itmbuy, '{$_POST['effect1on']}',
  '$efx1', '{$_POST['effect2on']}', '$efx2', '{$_POST['effect3on']}', '$efx3', $weapon, $armor)");
...
<input type='submit' STYLE='color: black;  background-color: white;' value='Give Item' /></form></div> <br></div></div></div></div></div>";
}
...
Item: ".item_dropdown($c,'item')."<br />
<input type='submit' STYLE='color: black;  background-color: white;' value='Kill Item' /></form></div> <br></div></div></div></div></div>";
}
...
Item: ".item_dropdown($c,'item')."<br />
<input type='submit' STYLE='color: black;  background-color: white;' value='Edit Item' /></form></div> <br></div></div></div></div></div>";
}
...
<input type='submit' STYLE='color: black;  background-color: white;' value='Add Item Type' /></form></div> <br></div></div></div></div></div>";
}
}
$h->endpage();
?>
