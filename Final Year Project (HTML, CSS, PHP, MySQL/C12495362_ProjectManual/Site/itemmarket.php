...
<a href='itemmarket.php'>Back</a></div><br></div></div></div></div></div>";
$h->endpage();
exit;
}
$r=$db->fetch_row($q);
...
<br/><a href='itemmarket.php'>Back</a></div><br></div></div></div></div></div> ";
}
else
{
...
<input type='submit' STYLE='color: black;  background-color: white;' value='Buy Item and Send Gift' /></form></div><br></div></div></div></div></div>";
}
else
{
