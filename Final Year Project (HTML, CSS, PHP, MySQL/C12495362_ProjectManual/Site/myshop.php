...
print"</table></div><br></div></div></div></div></div><center><br><br><a href=\"javascript: history.go(-1)\">Click here to go back</a></center>";
}
...
<input type=text name=sign value='{$us['image']}'><input type=hidden name=subm value=1><br><input type=submit value='Change Shop Sign'></form> </div><br></div></div></div></div></div>
...
<textarea name=desc rows=5 cols=30>{$us['description']}</textarea><br><input type=submit value='Change Shop Description'></form> </div><br></div></div></div></div></div>
<a href=\"javascript:history.go(-1)\">Click here to go back</a></center>";
}
}
...
<form action='myshop.php?do=changename' method='post'>Shop Name: <input type=text name=name><input type=submit value='Change Shop Name'></form></div><br></div></div></div></div></div>
<a href=\"javascript:history.go(-1)\">Click here to go back</a></center>";
}
}
...
<input type=submit value=Withdraw></form></div><br></div></div></div></div></div><br><a href=\"javascript:history.go(-1)\">Click here to go back</a></center>";
}
}
...
<form action='myshop.php?do=close' method='post'><input type=hidden name=yes value=1><input type=submit value='I am sure'></form><form action=\"javascript:history.go(-1)\" method=get><input type=submit value=Nervermind></form></div><br></div></div></div></div></div></center>";
}
}
