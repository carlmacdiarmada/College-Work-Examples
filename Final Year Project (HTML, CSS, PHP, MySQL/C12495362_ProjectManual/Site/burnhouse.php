...
<div class='generalinfo_simple'><br> <br><br>
        ...
        <input type = 'submit' STYLE='color: black;  background-color: green;' value = 'NO WAY' /> </form></div><br></div></div></div></div></div>";
    }
}
...
<div class='generalinfo_simple'><br> <br><br>
        ...
        <form action = 'index.php' method = 'post' />
        <input type = 'submit' STYLE='color: black;  background-color: white;' value = 'No, Go Home' /> </form></div><br></div></div></div></div></div>";
    }
}
