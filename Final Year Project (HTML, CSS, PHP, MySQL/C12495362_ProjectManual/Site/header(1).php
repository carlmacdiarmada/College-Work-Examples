    ...
    <nav class="navbar navbar-inverse navbar-static-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php"><style="color:#f8f8ff;"><b><a href='viewuser.php?u={$ir['userid']}'> $gn{$u} </a> [{$ir['userid']}] $d </b></a>
        </div>
...
<p><img src="images/profile_info.jpg" alt="Profile Information" /></p></div>
<style="color:#f8f8ff;"><b><a href='viewuser.php?u={$ir['userid']}'> $gn{$u} </a> [{$ir['userid']}] $d </b><br/>
...
<b>Guts:</b> {$ir['brave']}/{$ir['maxbrave']} <br />
