...
<a href='explore.php'>Back to town...</a></div><br></div></div></div></div></div> ";
}
}
else
{
print "Open a bank account today, just \$10,000,000!<br />
<a href='cyberbank.php?buy'>&gt; Yes, sign me up!</a></div><br></div></div></div></div></div> ";
}
}
function index()
{
...
<input type='submit' STYLE='color: black;  background-color: white;' value='Withdraw' /></form></td> </tr> </table></div><br></div></div></div></div></div> ";
}
function deposit()
{
global $db,$ir,$c,$userid,$h;
...
{
print "You do not have enough money to deposit this amount.</div><br></div></div></div></div></div></a>";
}
else
{
...
<a href='cyberbank.php'> Back</a></div><br></div></div></div></div></div>";
}
}
function withdraw()
{
...
{
print "You do not have enough banked money to withdraw this amount.</div><br></div></div></div></div></div></a>";
}
...
<b>You now have $balances in the Cyber Bank.</b><br />
<a href='cyberbank.php'> Back</a></div><br></div></div></div></div></div></a>";
