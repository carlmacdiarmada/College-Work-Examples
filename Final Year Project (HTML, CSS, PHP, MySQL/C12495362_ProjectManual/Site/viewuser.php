...
if($r['laston'] >= time()-15*60) { $on="color:green"; }  else { $on="color:red"; }
if($r['laston'] >= time()-15*60) { $status="Online"; } else { $status="Offline"; }
print "

<div class='icolumn2' id='mainContentDiv'>

<div class='gangpage_container' style='margin-center:0px;'>
<!-- Member Profile Page Starts -->
<!-- Member Content Part Starts -->
<div class='mem_conpart1_center'>
<div class='con_txt1'>{$r['username']} <span>[{$r['userid']}] $d </span> </div>
<div class='online_btn'> <img src='' alt='$status' title='$status' style='float: center'  /> </div>
<div class='user_centerimgpart'>

        <div class='user_centerimg1'> <div align='center'> <a href='sendcash.php?ID={$r['userid']}'>Send Cash</a> &nbsp&nbsp<br /> <a href='sendcrys.php?ID={$r['userid']}'>Send Crystals</a> &nbsp&nbsp<br/> <a href='attack.php?ID={$r['userid']}'>Attack</a>  &nbsp&nbsp <br/> <a href='friendslist.php?action=add&ID={$r['userid']}'>Add Friend</a>  &nbsp&nbsp <br />    <a href='mailbox.php?action=compose&ID={$r['userid']}'>Mail User</a></div></div>
    </div>

    <div class='user_centerimgpart'>
        <div class='user_centerimg1'> <div align='center'> <a href='killer.php'>Assassinate</a>&nbsp&nbsp<br/>      <a href='burnhouse.php?ID={$r['userid']}'>Arson</a>   &nbsp&nbsp <br/> <a href='contactlist.php?action=add&ID={$r['userid']}'>Add Contact</a>  &nbsp&nbsp  <br/><a href='blacklist.php?action=add&ID={$r['userid']}'>Add Enemy</a></div></div>
...
<div class='cap_txtpart'>
    ...
    <div class='cap_txt2'><span><font color='#70cb00'><b><img src='' alt='$status' title='$status'  /></b></font></span></div>
</div>
<div class='cap_txtpart'>
    <div class='cap_txt1'>Gang:</div>
    <div class='cap_txt2'>";
if($r['gang'])
{
...
<div>&nbsp; &nbsp; &nbsp;&nbsp;<a href='rating.php?ID={$r['userid']}&action=goodrating'>Give user good rating</a> <strong>&nbsp; {$r['ratings']} &nbsp;</strong>  <a href='rating.php?ID={$r['userid']}&action=badrating'>Give user bad rating</a><br /></div>
    </div>
</div>
...
<div class='mem_conpart1_center'>
<div class='mem_centerbg1' >

<div class='mem_center_imgpart'>
    </a>

    </div>
</div>
</div>
<div class='mem_centerbg2'>

<div class='useraction_txt'><img src='' alt='' /></div>
...
<div id='bubble' class='float_con' style='display:none; center: 100px; top: 400px;'>
...
<div id='spy_pop_out' style='padding: 10px; display: none; position: absolute; center: 10%; top: 200px; width: 400px; height: 60px; z-index: 100; background-color: #000000; border: 5px solid #222222'  class='generalinfo_simple'>
...
<br><table width=55% border=2 class=table-responsive style=padding-center:25%; >
...
<div class='user_imgpart'>
    <div class='user_centerimgpart'>
        ...
        <div class='user_centerimg5'> <div align='center'> <a href='jailuser.php?userid={$r['userid']}'>Jail</a></div> </div>
    </div>

    <div class='user_centerimgpart'>
        <div class='user_centerimg5'> <div align='center'> <a href='mailban.php?userid={$r['userid']}'>Mail Ban</a></div> </div>
...
<div class="usercmt_center">Profile Signature</div>
<div class="usercmt_center"></div>
</div>
 </div>
';
...
<div class="usercmtpart">
 <div class="usercmt_txtpart">
<div class="usercmt_center">User Comments</div>
<div class="usercmt_center"><a href=Comments.php?ID='.$_GET['u'].' >Add Comment</a></div>
</div>
 </div>
';
