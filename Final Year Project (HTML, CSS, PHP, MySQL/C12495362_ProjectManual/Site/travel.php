...
<tr>
<td><image alt="Plane" width="180" height="150"></td>
<td><image alt="Train" width="180" height="150"></td>
<td><image alt="Car" width="180" height="150"></td>
</tr>
...
Congratulations, you paid '.$tcost.' and start travelling ! It will take '.$rantime.' minutes to arrive.</div> <br></div></div></div></div></div>';
}
}
}
$h->endpage();
