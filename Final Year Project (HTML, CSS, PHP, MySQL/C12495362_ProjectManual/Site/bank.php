...
{
echo "You do not have enough money to open an account <a href='index.php'>Back to town....</a></div><br></div></div></div></div></div>";
$h->endpage(); exit;
}
}
...
<a href='bank.php?buy'>Yes, sign me up!</a> </div><br></div></div></div></div></div> ";
}
}
...
if($ir['bankmoney']<$_POST['wd']) { echo "You Tried Withdrawing <b>\$$with</b> but you only have <b>\$$bkmon</b></div><br></div></div></div></div></div></a>"; $h->endpage(); exit; }
$total=number_format($ir['bankmoney']-$_POST['wd']);
echo "You Successfully Withdrew <b>\$$with</b><br>You now have <b>\$$total</b> in your Bank.<br><a href='bank.php'>Back</a></div><br></div></div></div></div></div>";
...
if($ir['money']<$_POST['dt']) { echo "You tried depositing <b>\$$dep</b> but you only have <b>\$$mon</b><br> <a href='bank.php'>Back</a></div><br></div></div></div></div></div>"; $h->endpage(); exit; }
$blah=$_POST['dt']/50;
...
echo "You successfully deposited <b>\$$banky</b> out of <b>\$$dep</b> into your bank account<br>The banker toke his <b>\$$taken</b> cut<br>You now have <b>\$$total</b> in your bank.<br><a href='bank.php'>Back</a></div><br></div></div></div></div></div>";
