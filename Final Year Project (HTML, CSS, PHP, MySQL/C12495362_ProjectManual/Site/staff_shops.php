...
<input type='submit' STYLE='color: black;  background-color: white;' value='Create Shop' /></form></div> <br></div></div></div></div></div>";
}
...
<input type='submit' STYLE='color: black;  background-color: white;' value='Add Item To Shop' /></form></div> <br></div></div></div></div></div>";
}
...
Shop: ".shop_dropdown($c, "shop")."<br />
<input type='submit' STYLE='color: black;  background-color: white;' value='Delete Shop' /></form></div> <br></div></div></div></div></div>";
}
}
