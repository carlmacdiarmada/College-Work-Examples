...
<div class='info_mid'><h2 style='padding-top:10px;'> Global Forums </h2></div>
</div>
...
{
print "Sorry, you don't have permission to view this forum.<br />
...
<a href='forums.php?act=pin&topic={$_GET['viewtopic']}''>Pin/Unpin Topic  </a><a href='forums.php?act=lock&topic={$_GET['viewtopic']}''>Lock/Unlock Topic</a><a href='forums.php?act=deletopic&topic={$_GET['viewtopic']}''>Delete Topic</a><br />";
}
print "
<table cellspacing='1' class='table' width='100%' border='0'>\n";
...
{
print "Sorry, you don't permission to edit this post.<br />
&gt; <a href='forums.php'>Back</a>";
$h->endpage();
exit;
}
...
if(!($ir['user_level'] > 1 || $ir['userid']==$post['fp_poster_id']))
{
print "Sorry, you don't have permission to edit this post.<br />
&gt; <a href='forums.php'>Back</a>";
$h->endpage();
exit;
}
