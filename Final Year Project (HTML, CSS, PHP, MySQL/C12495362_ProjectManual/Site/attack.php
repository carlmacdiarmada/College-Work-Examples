...
{
print "<center>Self-attacking is not allowed, sorry.
<br><a href='index.php'>> Back Home <</a>";
$h->endpage();
exit;
}
...
{
print "<center>You're low on health. You should rest.
<br><a href='index.php'>>Back Home<</a>";
$h->endpage();
exit;
}
...
{
print "<center>You've already lost.
<br><a href='index.php'>> Back Home <</a>";
...
if($odata['hp'] == 1)
{
print "<center>This player is unconscious. Give them a break
<br><a href='index.php'>> Back Home <</a>";
$h->endpage();
...
if($odata['bguard'] >0)
{
print" <center><b><font color='#FFFF00'>Holy Shit!</b></font> You didn't realise they have a bodygaurd!! You were injured and taken to the hospital for $hospit min<br/><br/><a href='index.php'>>Home</a></center>";
$h->endpage();
...
<a href='index.php'>> Back Home <</a></center>";
$h->endpage();
$db->query("UPDATE users SET attacking=0 WHERE userid=$userid");
...
{
print "<center>You can't attack while in hospital, sorry.
<br><a href='index.php'>> Back Home <</a>";
$h->endpage();
$_SESSION['attacking']=0;
$ir['attacking']=0;
...
{
print "<center>You can't attack behin bars!
<br><a href='index.php'>> Back Home <</a>";
$h->endpage();
$_SESSION['attacking']=0;
$ir['attacking']=0;
...
{
print "<center>This player is travelling.
<br><a href='index.php'>> Back Home <</a>";
$h->endpage();
$_SESSION['attacking']=0;
$ir['attacking']=0;
...
{
print "<center>Are you really trying to do that with no health ?
<br><a href='index.php'>> Back Home <</a>";
$h->endpage();
exit;
}
...
{
print "<center>You need a Primary Weapon to attack...<br><a href='index.php'>> Back Home <</a>";
$h->endpage();
exit;
}
...
{
if ($youdata['energy'] >= $youdata['maxenergy']/6)
{

$youdata['energy']-= floor($youdata['maxenergy']/6);
$me=floor($youdata['maxenergy']/6);
...
{
print "Sorry, you don't have enough energy to attack.";
exit;
}
}
...
NB:If you don't choose one you will lose your energy and XP  <br /> <br />
...
$hitratio=max(10,min(60*$odata['labour']/$ir['agility'],95));
if(rand(1,100) <= $hitratio)
{
