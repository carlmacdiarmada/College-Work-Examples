...
<input type='submit' STYLE='color: black;  background-color: white;' value='Add City' /></form></div> <br></div></div></div></div></div>";
}
}
function editcity()
{
...
<input type='submit' STYLE='color: black;  background-color: white;' value='Edit City' /></form></div> <br></div></div></div></div></div>";
break;
default:
print "
...
City: ".location_dropdown($c, "city")."<br />
<input type='submit' STYLE='color: black;  background-color: white;' value='Delete City' /></form></div> <br></div></div></div></div></div>";
}
}
