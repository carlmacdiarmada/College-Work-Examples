...
<input type='submit' STYLE='color: black;  background-color: white;' value='Update Settings' /></form></div><br></div></div></div></div></div>";
}
}
...
<input type='submit' STYLE='color: black;  background-color: white;' value='Add Announcement' /></form></div><br></div></div></div></div></div>";
}
}
...
<input type='submit' STYLE='color: black;  background-color: white;' value='Update Notepad' /></form></div><br></div></div></div></div></div>";
}
$h->endpage();
?>
