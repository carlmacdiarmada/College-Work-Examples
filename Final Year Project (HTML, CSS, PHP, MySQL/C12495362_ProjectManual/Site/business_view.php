...
echo '</table> <br> <a href="business_create.php"><b>Create a Company</b></a> <br>  </div><br></div></div></div></div></div>
</p>';
}
function view_class()
{
...
</div><div class="generalinfo_simple"><br> <br><br><br><br>
...
echo '</table> <br><br><br> <a href="business_create.php"><b>Create a Company</b></a> <br></div><br></div></div></div></div></div> ';
}
}
else
{
