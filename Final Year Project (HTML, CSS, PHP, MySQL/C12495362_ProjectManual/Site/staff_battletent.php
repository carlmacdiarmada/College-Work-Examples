...
<input type='submit' STYLE='color: black;  background-color: white;' value='Add Challenge Bot' /></form></div><br></div></div></div></div></div>";
}
}
function editbot()
{
...
<input type='submit' STYLE='color: black;  background-color: white;' value='Edit Challenge Bot' /></form></div><br></div></div></div></div></div>";
break;
default:
print "
...
<input type='submit' STYLE='color: black;  background-color: white;' value='Remove Bot' /></form></div><br></div></div></div></div></div>";
}
}
$h->endpage();
?>
