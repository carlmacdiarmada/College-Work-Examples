...
Days: <input type='text' STYLE='color: black;  background-color: white;' name='days' /><br />
Reason: <input type='text' STYLE='color: black;  background-color: white;' name='reason' /><br />
<input type='submit' STYLE='color: black;  background-color: white;' value='Mailban User' /></form></div> <br></div></div></div></div></div>";
}
...
Days: <input type='text' STYLE='color: black;  background-color: white;' name='days' /><br />
Reason: <input type='text' STYLE='color: black;  background-color: white;' name='reason' /><br />
<input type='submit' STYLE='color: black;  background-color: white;' value='Forumban User' /></form></div> <br></div></div></div></div></div>";
}
...
User: ".fed_user_dropdown($c,'user')."<br />
<input type='submit' STYLE='color: black;  background-color: white;' value='Unjail User' /></form></div> <br></div></div></div></div></div>";
}
...
<input type='submit' STYLE='color: black;  background-color: white;' value='Un-mailban User' /></form></div> <br></div></div></div></div></div>";
}
...
<input type='submit' STYLE='color: black;  background-color: white;' value='Un-forumban User' /></form></div> <br></div></div></div></div></div>";
}
...
<input type='submit' STYLE='color: black;  background-color: white;' value='Search' /></form></div> <br></div></div></div></div></div>";
}
...
<input type='submit' STYLE='color: black;  background-color: white;' value='Mass Jail' /></form></div> <br></div></div></div></div></div>";
}
function mass_jail()
{
global $db,$ir,$c,$h,$userid;
