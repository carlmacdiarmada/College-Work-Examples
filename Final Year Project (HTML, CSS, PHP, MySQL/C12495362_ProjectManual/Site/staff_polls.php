...
<input type='submit' STYLE='color: black;  background-color: white;' value='Submit'></form></div> <br></div></div></div></div></div>";
}
...
print "<input type='submit' STYLE='color: black;  background-color: white;' value='Close Selected Poll' /></form></div> <br></div></div></div></div></div>";
}
else
{
