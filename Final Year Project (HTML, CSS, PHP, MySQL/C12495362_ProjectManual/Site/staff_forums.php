...
<input type='submit' STYLE='color: black;  background-color: white;' value='Add Forum' /></form></div> <br></div></div></div></div></div>";
}
}
function editcity()
{
...
print "
<input type='submit' STYLE='color: black;  background-color: white;' value='Edit Forum' /></form></div> <br></div></div></div></div></div>";
break;
default:
print "
<div class='generalinfo_txt'>
...
<input type='submit' STYLE='color: black;  background-color: white;' value='Delete Forum' /></form></div> <br></div></div></div></div></div>";
}
}
