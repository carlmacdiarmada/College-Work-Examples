...
<tr><td>From: <font color=red>* </font><input type=text STYLE='color: black;  background-color: white;' name=levelmin  value={$p['levelmin']}></td>
 ...
 <tr><td>From: <input type=text STYLE='color: black;  background-color: white;' name=daysmin  value={$p['daysmin']}></td>
...
<tr><td colspan='2'><br /><input type='submit' STYLE='color: black;  background-color: white;' name='search' value='Search'>     <input type='submit' STYLE='color: black;  background-color: white;' name='save' value='Search and Save'>     <input type='submit' STYLE='color: black;  background-color: white;' name='clear' value='Clear Saved Search'></form></td></tr></table></div><br></div></div></div></div></div>";
...
<div class='searchpage'>
            ...
            <div class='generalinfo_txt'>
<div class='info_mid'><h2 style='padding-top:10px;'> User Lookup</h2></div>
</div>
...
<tr><td>From: <font color=red>* </font><input type=text STYLE='color: black;  background-color: white;' name=levelmin value=1></td>
 ...
 <tr><td colspan='2'>Search by Age</td></tr>
 <tr><td>From: <input type=text STYLE='color: black;  background-color: white;' name=daysmin></td>
